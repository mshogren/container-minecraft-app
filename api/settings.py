...
class SchemaLabels:
    ...
    ADDSERVERERROR_TYPE_NAME = "AddServerError"
    ADDSERVERERROR_TYPE_DESCRIPTION = "A type that encapsulates error information returned by the AddServer mutation"
    ADDSERVERERROR_ERROR_FIELD_NAME = "error"
    ADDSERVERERROR_ERROR_FIELD_DESCRIPTION = "An error return by the AddServer mutation"
    ADDSERVERINPUT_TYPE_NAME = "AddServerInput"
    ADDSERVERINPUT_TYPE_DESCRIPTION = "A type that encapsulates the information required by the AddServer mutation"
    ADDSERVERINPUT_NAME_FIELD_NAME = "name"
    ADDSERVERINPUT_NAME_FIELD_DESCRIPTION = "The name of the Mincraft Server to be added"
    ADDSERVERRESPONSE_TYPE_NAME = "AddServerResponse"
    ADDSERVERRESPONSE_TYPE_DESCRIPTION = "A union type used for returning the result of the AddServer mutation"
    ADDSERVERSUCCESS_TYPE_NAME = "AddServerSuccess"
    ADDSERVERSUCCESS_TYPE_DESCRIPTION = "A type that encapsulates the information returned by successful AddServer mutation"
    ADDSERVERSUCCESS_SERVER_FIELD_NAME = "server"
    ADDSERVERSUCCESS_SERVER_FIELD_DESCRIPTION = "The details of the Minecraft server added by the AddServer mutation"
    ...
    MUTATION_ADDSERVER_FIELD_NAME = "addServer"
    MUTATION_ADDSERVER_FIELD_DESCRIPTION = "The mutation used to add a Minecraft server"
    MUTATION_ADDSERVER_ARGUMENT_NAME = "server"
    MUTATION_ADDSERVER_ARGUMENT_DESCRIPTION = "The AddServerInput used to add a Minecraft server"
    PORT_TYPE_NAME = "Port"
    ...
    QUERY_MODPACK_MODPACKID_ARGUMENT_NAME = "modpackId"
    QUERY_MODPACK_MODPACKID_ARGUMENT_DESCRIPTION = "the id of the modpack to retrieve"
    QUERY_MODPACKS_FIELD_NAME = "modpacks"
    QUERY_MODPACKS_FIELD_DESCRIPTION = "A query for a collection of modpacks"
    QUERY_MODPACKS_PAGE_ARGUMENT_NAME = "page"
    QUERY_MODPACKS_PAGE_ARGUMENT_DESCRIPTION = "The number of the results page, starting at 0"
    QUERY_MODPACKS_SEARCH_ARGUMENT_NAME = "search"
    QUERY_MODPACKS_SEARCH_ARGUMENT_DESCRIPTION = "Text to search for in the modpack names and descriptions"
    QUERY_SERVER_FIELD_NAME = "server"
    QUERY_SERVER_FIELD_DESCRIPTION = "A query for a single Minecraft server"
    QUERY_SERVER_SERVERID_ARGUMENT_NAME = "serverId"
    QUERY_SERVER_SERVERID_ARGUMENT_DESCRIPTION = "The id of the Minecraft server to retrieve"
