...
class SchemaLabels:
    ...
    STATUS_ENUM_NAME = "StatusEnum"
    STATUS_ENUM_DESCRIPTION = "An enumeration of the possible server statuses"
    STATUS_ENUM_AVAILABLE_DESCRIPTION = "An available server"
    STATUS_ENUM_UNAVAILABLE_DESCRIPTION = "An unavailable server"
